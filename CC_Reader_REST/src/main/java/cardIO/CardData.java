...
public class CardData {
    ...
    public static CardData getCardDataFromJson(String json_path)
    {
        JSONObject json_o = new JSONObject(json_path);
        String birthDate = json_o.getString("birthDate");
        /*
        card_js.put("birthDate", this.birthDate);
        card_js.put("cardNumber", this.cardNumber);
        card_js.put("cardNumberPAN", this.cardNumberPAN);
        ...
        return new CardData(birthDate, birthDate, birthDate, birthDate, json_path, birthDate, json_path, birthDate, json_path, json_path, json_path, json_path, json_path, birthDate, birthDate, birthDate, json_path, json_path, birthDate, birthDate, birthDate, birthDate, birthDate, birthDate, birthDate, birthDate);
    }
